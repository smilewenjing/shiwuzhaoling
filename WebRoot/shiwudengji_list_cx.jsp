...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='shiwudengji_listxls.jsp';" />
</form>
...
//txixixngdy
    ...
    String url = "shiwudengji_list_cx.jsp?1=1"; 
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="90" align="center"><a href="shiwudengji_updtlb.jsp?id=<%=map.get("id")%>"></a>  <a href="shiwudengji_list_cx.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')"></a> <a href="shiwudengji_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>

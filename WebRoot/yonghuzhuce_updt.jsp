...
function check()
{
	if(document.form1.yonghuming.value==""){alert("请输入学号");document.form1.yonghuming.focus();return false;}if(document.form1.mima.value==""){alert("请输入密码");document.form1.mima.focus();return false;}if(document.form1.xingming.value==""){alert("请输入姓名");document.form1.xingming.focus();return false;}
}
</script>
...
%>
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     <tr><td>学号：</td><td><input name='yonghuming' type='text' id='yonghuming' value='' readonly="readonly" /> 此项不得修改 </td>
	 ...
	 <tr><td>院系：</td><td><input name='QQ' type='text' id='QQ' value='' /></td></tr><tr><td>邮箱：</td><td><input name='youxiang' type='text' id='youxiang' value='' /></td></tr>
	 ...
	 <tr><td>校园卡照片：</td><td><input name='touxiang' type='text' id='touxiang' size='50' value='' />&nbsp;<input type='button' value='上传' onClick="up('touxiang')"/></td></tr>

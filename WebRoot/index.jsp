...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
	...
	<tr>
		<td><table id="__01" width="1000"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="top"><%@ include file="qtleft.jsp"%></td>
            <td valign="top"><table id="__01" width="770"  border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><table id="__01" width="770" height="276" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="770" height="36" background="qtimages/1_02_02_01_01.gif"><table width="98%" height="22" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="17%" align="center"><strong><a href="news.jsp?lb=站内新闻">站内新闻</a></strong></td>
                        <td width="83%">&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
    ...
    for(HashMap map:new CommDAO().select("select * from xinwentongzhi where leibie='站内新闻' order by id desc ",1,8)){
                  ...
                  <tr>
                    <td><table id="__01" width="384" height="305" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="384" height="35" background="qtimages/1_02_02_03_01_01.gif"><table width="98%" height="17" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="37%" height="17" align="center" valign="bottom"><strong><a href="news.jsp?lb=寻物启事" ><font class="STYLE1">寻物启事</font></a></strong></td>
                            <td width="63%">&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
                        ...
                        <td><table id="__01" width="384" height="260" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="366" height="260" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="newsline">
                              <%
                                for(HashMap map:new CommDAO().select("select * from xinwentongzhi where leibie='寻物启事' order by id desc",1,9)){
								%>
                              <tr height="25">
                    ...
                    <td><table id="__01" width="384" height="305" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="384" height="35" background="qtimages/1_02_02_03_01_01.gif"><table width="98%" height="17" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="37%" height="17" align="center" valign="bottom"><strong><a href="news.jsp?lb=失物招领" ><font class="STYLE1">失物招领</font></a></strong></td>
                            <td width="63%">&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td><table id="__01" width="384" height="260" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="366" height="260" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="newsline">
                              <%
                                for(HashMap map:new CommDAO().select("select * from xinwentongzhi where leibie='失物招领' order by id desc",1,9)){
								%>
                              <tr height="25">
                                <td width="7%" align="center" class="newslist"><img src="qtimages/1.jpg" width="7" height="7"  /></td>
                                <td width="93%" class="newslist"><a href="gg_detail.jsp?id=<%=map.get("id")%>"><%=Info.ensubStr(map.get("biaoti"),26)%></a></td>

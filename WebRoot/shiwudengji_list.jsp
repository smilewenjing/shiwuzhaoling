...
//youzuiping2
  ...
  <tr>
    ...
    <td width="90" align="center"><a href="shiwudengji_updtlb.jsp?id=<%=map.get("id")%>">回复</a>  <a href="shiwudengji_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="shiwudengji_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
